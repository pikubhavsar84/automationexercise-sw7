...
#        11. Click 'Home' button and verify that landed to home page successfully
 ...
 @sanity @smoke
  Scenario: User should log the contact us form
    ...
    And I enter "Mona" name to name field
    And I enter "monal1289@yahoo.com" email to email field
...
#        7. Verify success message 'You have been successfully subscribed!' is visible
  ...
  Scenario: User should subscribe in the homepage
    ...
    Then I enter email "monal1289@yahoo.com"
...
#        22. Verify 'ACCOUNT DELETED!' and click 'Continue' button
  ...
  Scenario: User should download invoice after purchase order
    ...
    And I fill all details in signup page "Mrs" "mona" "14" "January" "1988" "Heena" "Patel" "Rugby Avenue" "Lalbaugh" "India" "Gujarat" "Surat" "395001" "09584766214"
