...
#        18. Verify that 'ACCOUNT DELETED!' is visible and click 'Continue' button
 ...
 @BeforeTest @sanity @smoke
  Scenario: User should create account successfully
    ...
    And I send name "Mona" and email "mona" to signup
    And I click on button "Signup"
    Then I should see text "ENTER ACCOUNT INFORMATION"
    And I fill all details in signup page "Mrs" "mona1289" "14" "January" "1988" "Mona" "Lisa" "foot Avenue" "naranpura" "India" "Gujarat" "ahmedabad" "395001" "09584766214"
   ...
   #   And I handle Add
#   And I dissmiss popup
#  When  I accept all cookies
    Then I should see the text "Logged in as " "Mona"
...
#        8. Verify error 'Email Address already exist!' is visible
 ...
 @smoke
  Scenario: User should see error message while register with existing email
    ...
    When I click on header menu option "Signup / Login"
    Then I should see the login page text "New User Signup!"
    And I send name "Mona" to name field in signup
    And I send email "monal1289@yahoo.com" to email field in signup
    And I click on button "Signup"
...
#        20. Verify 'ACCOUNT DELETED!' and click 'Continue' button
  ...
  Scenario: User should Place Order: Register while Checkout
    ...
    And I enter payment details "Mona Lisa" "4263982640269299" "837" "02" and "2026"
...
#        17. Verify 'ACCOUNT DELETED!' and click 'Continue' button
  ...
  Scenario: User should place the order successfully : Login before Checkout
    ...
    And I enter "monal1289@yahoo.com" email and "moli1289" password for login
